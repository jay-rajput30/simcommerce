...
const Cart = () => {
  const { _, cartItems, dataDispatch } = useData();
  ...
  return (
    <section className="primary--section text--color__primary">
      ...
      <h2 className="text-utility heading">Total amount: (Rs.) {totalPrice} </h2>
                      ...
                      <div className="cart--item">
                        <div class="cart--item__details">
                          ...
                          <div className="cart--item__button-group">
                            ...
                            <button onClick={()=>dataDispatch({type:"CART_REMOVE", payload:item})} className="button secondary--button">remove</button>
                          </div>
                        </div>
